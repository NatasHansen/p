...
<head>
    ...
    <link rel="stylesheet" href="css/lancamentostyle.css">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light navproprio" style=" z-index: 100; width: 100%;">
    ...
    <div class="card-geral">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="img/c1.jpg" alt="card">
                <a href="visualizacao_livro.php" class="fill-divc">
                <div class="card-body">
        ...
        <div class="card">
            ...
            <div class="card">
                <img class="card-img-top img-fluid" src="img/c3.jpg" alt="card">
                <a href="visualizacao_livro.php" class="fill-divc">
                <div class="card-body">
        ...
        <div class="card">
            <img class="card-img-top img-fluid" src="img/c4.jpg" alt="card">
            <a href="visualizacao_livro.php" class="fill-divc">
            <div class="card-body">
        ...
        <div class="card">
            <img class="card-img-top img-fluid" src="img/c5.jpg" alt="card">
            <a href="visualizacao_livro.php" class="fill-divc">
            <div class="card-body">
        ...
        <div class="card">
            <img class="card-img-top img-fluid" src="img/c6.jpg" alt="card">
            <a href="visualizacao_livro.php" class="fill-divc">
            <div class="card-body">
